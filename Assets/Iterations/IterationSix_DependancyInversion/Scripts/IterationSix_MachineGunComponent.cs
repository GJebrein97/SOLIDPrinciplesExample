...
{
    public class IterationSix_MachineGunComponent : MonoBehaviour, IterationSix_IWeapon, IterationSix_IAttackSpeed, IterationSix_IShootable, IterationSix_IReloadable 
    {
        ...
        public virtual void ShootBullet()
        {
            if (BulletPrefab)
            {
                if (Instantiate(BulletPrefab, ShootingEffect.transform).TryGetComponent<IterationSix_IBullet>(out var bullet))
                {
